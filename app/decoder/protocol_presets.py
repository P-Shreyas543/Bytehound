...
PRESET_WAVESHARE_CAN: Dict[str, List[Dict[str, Any]]] = {
    "Protocol": [{
        "profile_name": "Waveshare USB-CAN (Variable-Length)",
        "parser_type": "waveshare_can_variable_length",
        "header_hex": "AA",
        "frame_id_size": 2,
        "frame_id_byte_order": "little",
        "length_size": 1,
...
PRESET_WAVESHARE_CAN_FIXED_20: Dict[str, List[Dict[str, Any]]] = {
    "Protocol": [{
        "profile_name": "Waveshare USB-CAN (Fixed 20-Byte)",
...
BUILTIN_PRESETS: Dict[str, Dict[str, List[Dict[str, Any]]]] = {
    ...
    "Waveshare USB-CAN (Variable-Length)": PRESET_WAVESHARE_CAN,
    "Waveshare USB-CAN (Fixed 20-Byte)": PRESET_WAVESHARE_CAN_FIXED_20,
